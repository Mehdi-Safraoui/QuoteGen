...
const SignUp = () => {
  ...
  const signIn = (e) => {
    ...
    createUserWithEmailAndPassword(auth, email, password)
      .then((userCredential) => {
        ...
        // Réinitialisez les valeurs après le succès
        setEmail("");
        setPassword("");
        setIsSuccess(true);
  ...
  return (
    <>
      <form className="max-w-md mx-auto text-blue-700" onSubmit={signIn}>
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
          <div class="relative z-0 w-full mb-5 group">
            <div className="relative z-0 w-full mb-5 group">
              <input
                type="tel" name="floating_phone" id="floating_phone" required
          ...
          <div className="relative z-0 w-full mb-5 group">
            <input
              type="text" id="floating_city" name="floating_city" required
              className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
            />
            <label
